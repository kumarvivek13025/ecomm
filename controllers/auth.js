...
exports.signin = async (req, res) => {
  ...
  try {
    ...
    const token = jwt.sign({ _id: user._id }, 'ef58658a45d206fe361934ec314c80e4ebd1f0e6ab70a64bccac2749a64c003c');
...
exports.requireSignin = expressJwt({
  secret:'ef58658a45d206fe361934ec314c80e4ebd1f0e6ab70a64bccac2749a64c003c',
  // algorithms: ['RS256'],
  userProperty: 'auth',
});
